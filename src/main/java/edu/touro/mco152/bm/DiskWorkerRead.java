...
/**
 *This class only knows how to do 'read' disk benchmarks. It is instantiated by the
 *startBenchmark() method in DiskWorker.
 **/

public class DiskWorkerRead {



    public static void justRead(UIBluePrint uiBluePrint) throws IOException {
